...
@section('content')
    <!-- row -->
    <div class="row">
        {{Form::model($articleinfos,array('route' =>array( 'zhanhui_edit','id'=>$id),'method' => 'put','files' => true,))}}
        <div class="col-md-12">
            <!-- The time line -->
            <ul class="timeline">
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-footer">
                            <button class="btn btn-warning btn-flat btn-xs" disabled="disabled"></button>
                        </div>
                    </div>
                </li>
                <!-- END timeline item -->
