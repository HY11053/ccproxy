    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="padding:0 0 0 15px;" href="http://www.clantrip.com"><img alt="Brand" style="max-width:130px;"
...
<div class="main">
    <div class="item item2" style="padding-bottom:0">
        ...
        <a href="http://q.url.cn/ABRN33?_type=wpa&amp;qidian=true&amp;_pid=duqdwt.atd1km.jr5so9qj" target="_blank" class="zx" style="margin-bottom: 40px;">立即免费试用</a>
    </div>
    ...
    <div class="chanye">
        ...
        <ul class="xiangmu clearfix">
            <li class="lio">
                <div class="tub" style="background:url(/frontend/images/join_xiangmu_tu1-2.jpg) no-repeat center;"><img src="/frontend/images/join_xiangmu_tu1.jpg"></div>
                <h4>合作条件<br>
                    <span>FRANCHIES CONDITIONS</span></h4>
                热爱幼儿教育事业<br>
                具有200万以上的投资能力<br>
                拥有1500平方米以上<br>
                开办中高档幼儿园的意向选址<br>
                ...
                具有合作意识<br>
                能服从合作总部的统一管理<br><br>
                <a class="ant" href="/project/kindergarten/">了解项目</a>
            </li>
            <li class="lif">
                <div class="tub" style="background:url(/frontend/images/join_xiangmu_tu4-2.jpg) no-repeat center;"><img src="/frontend/images/join_xiangmu_tu4.jpg"></div>
                <h4>合作条件<br>
                    <span>FRANCHIES CONDITIONS</span></h4>
                热爱教育事业<br>
                具有50万以上的投资能力<br>
                ...
                遵循大风车的教学理念与管理体系<br>
                具有合作意识<br>
                能长久配合总部的统一管理<br><br><br><br>
                <a class="ant" href="/project/nursery/">了解项目</a>
            </li>
            <li class="lit">
                <div class="tub" style="background:url(/frontend/images/join_xiangmu_tu2-2.jpg) no-repeat center;"><img src="/frontend/images/join_xiangmu_tu2.jpg"></div>
                <h4>合作条件<br>
                    <span>FRANCHIES CONDITIONS</span></h4>
                热爱早期教育事业<br>
                具有150万以上的投资能力<br>
                ...
                具有强烈的品牌意识以及发展眼光<br>
                能服从合作总部的统一管理<br><br>
                <a class="ant" href="/project/baby/">了解项目</a>
            </li>
            <li class="lith">
                <div class="tub" style="background:url(/frontend/images/join_xiangmu_tu3-2.jpg) no-repeat center;"><img src="/frontend/images/join_xiangmu_tu3.jpg"></div>
                <h4>合作条件<br>
                    <span>FRANCHIES CONDITIONS</span></h4>
                热爱少儿英语培训事业<br>
                具有100万以上的投资能力<br>
                ...
                教学理念与管理体系<br>
                具有合作意识<br>
                能长久配合总部的统一管理<br><br><br>
                <a class="ant" href="/project/drama/">了解项目</a>
            </li>
            <div class="cl"></div>
        </ul>
    </div>
...
<div id="copyright">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <p>Copyright © 2006-2019 clantrip.com All Rights Reversed. 中岚签证 <a target="_blank" href="http://www.miitbeian.gov.cn/">京ICP备16015317号</a></p>
